...
class HUB:
    def __init__(self):
        ...
        self.url2='https://pass.hust.edu.cn/cas/login?service=http%3A%2F%2Fhub.hust.edu.cn%2Fhustpass.action'
...
##        self.getContent(self.url1,self.postData1,self.headers1)
        self.getContent(self.url2,self.postData2,self.headers2)
##
        ##中间页面提取表单内容
